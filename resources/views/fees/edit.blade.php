          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              {{-- <form action="{{route('process.store')}}"method="post"enctype="multipart/form-data">
                @csrf --}}
                <form id="signupform" class="col-md-10 mx-auto" method="Post" action="{{route('fees.update',$fees->id)}}">
                @csrf
                <!-- /.box-header -->
                <div class="box-body">
                  <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                   <div class="card-body">
                    <h4 class="card-title">Fees invoice  </h4>
                    <p class="card-description"> user fees </p>
                    <form class="forms-sample">
                        <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Amount paid</label>
                        <input type="number" class="form-control"  placeholder="amount" name="amount" value="{{$fees->amount}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Balance amount</label>
                        <input type="number" class="form-control"  placeholder="balance" name="balance" value="{{$fees->balance}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Current amount</label>
                        <input type="number" class="form-control"  placeholder="cuurrent" name="current" value="{{$fees->current}}">
                      </div>
                      {{-- <div class="form-group">
