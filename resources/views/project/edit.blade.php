          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                   <div class="card-body">
                    <h4 class="card-title">Project tracking</h4>
                    <p class="card-description"> user projects</p>
                    <form class="forms-sample">
                      <div class="form-group">
                        <label for="exampleInputName1">Project name</label>
                        <input type="text" class="form-control"  placeholder="name" name="name" value="{{$project->name}}" >
                      </div>
                      {{-- <div class="form-group">
                        <label for="exampleSelectGender">Projects</label>
                        <select class="form-control" id="exampleSelectGender" aria-placeholder="projects" name="projects">
                          <option>pro-1</option>
                          <option>pro-2</option>
                          <option>pro-3</option>
                          <option>pro-4</option>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Project code</label>
                        <input type="number" class="form-control"  placeholder="code" name="code" value="{{$project->code}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleSelectGender">Status</label>
                        <select class="form-control" id="exampleSelectGender" aria-placeholder="status" name="status" value="{{old('status')}}">
                          <option></option>
