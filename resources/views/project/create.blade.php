          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              {{-- <form action="{{route('process.store')}}"method="post"enctype="multipart/form-data">
                @csrf --}}
                <form id="signupform" class="col-md-10 mx-auto" method="Post" action="{{route('project.store')}}">
                    @csrf
                <!-- /.box-header -->
                <div class="box-body">
                  <div class="row">
                   ...
                   <div class="card-body">
                    ...
                    <form class="forms-sample">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control" id="exampleSelectGender" aria-placeholder="status" name="status" >
                          <option></option>
