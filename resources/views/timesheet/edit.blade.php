        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> TIMESHEET FORM </h3>
            ...
            <div class="row">
              ...
              {{-- <form action="{{route('process.store')}}"method="post"enctype="multipart/form-data">
                @csrf --}}
                <form id="signupform" class="col-md-10 mx-auto" method="Post" action="{{route('timesheet.update',$timesheet->id)}}">
                    @csrf
                <!-- /.box-header -->
                <div class="box-body">
                  <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                   <div class="card-body">
                    <h4 class="card-title">timesheet form </h4>
                    <p class="card-description"> user timesheet </p>
                    <form class="forms-sample">
                      <div class="form-group">
                        <label for="exampleInputName1">Date</label>
                        <input type="date" class="form-control"  placeholder="date" name="date" value="{{$timesheet->date}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleSelectGender">Projects</label>
                        <select class="form-control" id="exampleSelectGender" aria-placeholder="projects" name="projects" value="{{$timesheet->projects}}">
                          <option>pro-1</option>
                          <option>pro-2</option>
                          <option>pro-3</option>
                          <option>pro-4</option>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Tasks</label>
                        <input type="text" class="form-control"  placeholder="tasks" name="tasks" value="{{$timesheet->tasks}}">
                      </div>
                      <div class="form-group">
                        <label for="Status">status </label>
                            <select name="status" select id="status"  class="form-control"   placeholder="status"  value="{{old('status')}}">
                                ...
                                <option value="1" {{ $timesheet->status == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0"  {{ $timesheet->status == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                            </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="remarks" name="remarks" value="{{$timesheet->remarks}}">
                      </div>
                      {{-- <div class="form-group">
                        <label for="exampleSelectGender">Select_faculty</label>
                        <select class="form-control" id="exampleSelectGender" aria-placeholder="select_faculty" name="select_faculty">
                          <option>BSC</option>
                          <option>MBA</option>
                          <option>BCCA</option>
                          <option>B.COM</option>
