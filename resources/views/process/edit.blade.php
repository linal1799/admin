        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> STUDENTS REGISTRATION FORM </h3>
            ...
            <div class="row">
              ...
              {{-- <form action="{{route('process.store')}}"method="post"enctype="multipart/form-data">
                @csrf --}}
                <form id="signupform" class="col-md-10 mx-auto" method="Post" action="{{route('process.update',$process->id)}}"enctype="multipart/form-data">
                    @csrf
                   ...
                   <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="name" name="name" value="{{$process->name}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Address</label>
                        <input type="address" class="form-control"  placeholder="address" name="address"  value="{{$process->address}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Pin_code</label>
                        <input type="number" class="form-control"  placeholder="pin_code" name="pin_code"  value="{{$process->pin_code}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Adhar_id</label>
                        <input type="number" class="form-control"  placeholder="adhar_id" name="adhar_id"  value="{{$process->adhar_id}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Mobile</label>
                        <input type="number" class="form-control"  placeholder="mobile" name="mobile"  value="{{$process->mobile}}">
                      </div>
                      <div class="form-group">
                        <label for="exampleSelectGender">Select_faculty</label>
                        <select class="form-control" id="exampleSelectGender" aria-placeholder="select_faculty" name="select_faculty"  value="{{$process->select_faculty}}">
                          <option>BSC</option>
                          <option>MBA</option>
                          <option>BCCA</option>
                          <option>B.COM</option>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" placeholder="gender" name="gender" value="{{$process->gender}}">
                          <option>Male</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="education" name="education"  value="{{$process->education}}">
                      </div>
                      <div class="form-group">
                        <label>upload file</label>
                        <input type="file" name="upload_file" class="file-upload-default">
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled placeholder="Upload File"  value="{{$process->upload_file}}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="email" name="email"  value="{{$process->email}}">
                      </div>
                      <div class="form-group">
                        <label>profile image</label>
                        <input type="file" name="profile_image" class="file-upload-default">
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image"  value="{{$process->profile_image}}">
                          <span class="input-group-append">
