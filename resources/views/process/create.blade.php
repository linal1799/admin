          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              {{-- <form action="{{route('process.store')}}"method="post"enctype="multipart/form-data">
                @csrf --}}
                <form id="signupform" class="col-md-10 mx-auto" method="Post" action="{{route('process.store')}}"enctype="multipart/form-data">
                    @csrf
                <!-- /.box-header -->
                <div class="box-body">
                  <div class="row">
                   ...
                   <div class="card-body">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control"  placeholder="pin_code" name="pin_code">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Adhar_id</label>
                        <input type="number" class="form-control"  placeholder="adhar_id" name="adhar_id">
                      </div>
                      <div class="form-group">
